<template>
  ...
  </svg></g></g></g></g></svg></div> <div class="d-flex flex-column flex-grow-1"><p class="d-flex title fw-400 fs-14 text-ellipsis mb-0"><span class="flex">{{item.username}}</span> <span class="d-flex justify-content-end align-items-center"><small class="text-muted">2021-12-24</small></span></p></div></div></div>
                          <!-- --------- -->
