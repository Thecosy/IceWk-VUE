<template>
 ...
 <el-row>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="邮箱：">
                  <el-input style="width: 180px" v-model="form.name"></el-input>@qq.com
                </el-form-item>
              </el-col>
  ...
  <el-form-item label="出生日期">
    <el-col :span="11">
      <el-date-picker type="date" placeholder="选择日期" v-model="form.busterday" style="width: 100%;"></el-date-picker>
    </el-col>
  </el-form-item>
...
@import "../../static/mycss/user_info.css";
    ...
    .newsflashes-nav-in ul li.current-menu-item a {
      background-color: rgba(42, 189, 128, 0.18)
    }
    ...
    .circle-vote {
      background: rgba(42, 189, 128, 0.04)
    }
    ...
    #video-list ul li>div:hover {
      background-color: rgba(42, 189, 128, 0.04)
    }
